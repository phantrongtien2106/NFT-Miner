...
Make sure you have the required NFTPlugin installed on your server. You can download it from [here](https://github.com/yourusername/NFTPlugin).

### Step 2: Download NFTMiner
Download the latest version of NFTMiner from our [releases page](https://github.com/yourusername/NFTMiner/releases).

### Step 3: Install the Plugin
Place the downloaded JAR file in your server's `plugins` folder.

### Step 4: Start Your Server
Start or restart your Minecraft server. The plugin will generate default configuration files.

### Step 5: Configure the Plugin
Edit the configuration files to customize the plugin to your needs. See the [Configuration](#%EF%B8%8F-configuration) section for details.

### Step 6: Restart Your Server
Restart your server to apply the changes.

### Step 7: Verify Installation
Use the `/token` command in-game to verify that the plugin is working correctly.
</details>
...
<details>
<summary><b>🔧 Configuration Sections Explained</b></summary>

### Block Values
Configure how many tokens players receive for mining different block types.

### MinePath Integration
Settings for connecting to the MinePath plugin database.

### Mining Box
Configure the dimensions and properties of player mining areas.

### Speed Upgrade
Configure the maximum level, costs, and effects of speed upgrades.

### Inventory Upgrade
Configure the maximum level and costs of inventory capacity upgrades.

### Token Value Upgrade
Configure the maximum level, costs, and multipliers for token value upgrades.
  ...
  <table>
    <tr>
      ...
      <td align="center" width="33%">
        ...
        <p>Join our <a href="https://discord.gg/yourdiscord">Discord server</a> for community support</p>
      </td>
      <td align="center" width="33%">
